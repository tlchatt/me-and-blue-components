...
export default function Contact() {
   ...
   * <iframe src="https://component.tlchatt.com/ContactFormKatKing" style="height: 700px; width:
      ...
      <script>
        ...
        function handleMessage(event) {
          if(event.origin != 'https://www.kyattkinglaw.com.com' ){
  ...
  return (
    <div className={styles.ContactForm} id="Contact" style={Style}>
      ...
      <form id="Contact-Form" className={styles.Form}>
        ...
        <ContactFormItem id="message" content="Brief Description of your legal needs" type="textarea" Icon={Message} />
